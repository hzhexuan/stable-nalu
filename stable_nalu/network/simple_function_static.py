...
class MultiFunctionStaticNetwork(ExtendedTorchModule):
    ...
    def __init__(self, unit_name, input_size=100, hidden_size_add=8, hidden_size_mul = 32, writer=None, first_layer=None, nac_mul='none', eps=1e-7, **kwags):
        super().__init__('network', writer=writer, **kwags)
        self.unit_name = unit_name
        self.input_size = input_size
        self.nac_mul = nac_mul
        ...
        self.layer_1 = GeneralizedLayer(input_size, hidden_size_add,
                                        unit_name_1,
                                        writer=self.writer,
                                        name='layer_1',
                                        eps=eps, **kwags)
        ...
        self.layer_2 = GeneralizedLayer(hidden_size_add, hidden_size_mul,
                                        'linear' if unit_name_2 in BasicLayer.ACTIVATIONS else unit_name_2,
                                        writer=self.writer,
                                        name='layer_2',
                                        eps=eps, **kwags)
        unit_name_3 = unit_name

        self.layer_3 = GeneralizedLayer(hidden_size_mul, 1,
                                        unit_name_3,
                                        writer=self.writer,
                                        name='layer_3',
                                        eps=eps, **kwags)
    ...
    def forward(self, input):
        ...
        self.writer.add_summary('z_3', z_3)
        return z_3
